        ...
        `<div class="col-xs-10 col-md-10 col-lg-8 offset-lg-2 main mt-5">
            <div class="row">          
                <div class="card-body p-5">
                    ...
                    <a class="text-primary" href="pages/books_by_author.html?id=${id}"> <i class="fa fa-book"></i> Books by ${name}</a>
                    
                    <br>
                    
                    <a href="pages/all_authors.html"> <i class="fa fa-angle-double-left mt-5 justify-content-end"></i> Back to all authors </a>
                  </div>       
