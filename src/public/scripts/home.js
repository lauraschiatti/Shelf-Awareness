...
$(document).ready ( function(){
    ...
    fetch('v2/books')
        ...
        for(let i = 0; i< json.length; i++) {
            ...
            listItem.innerHTML =
                `<div class="card mb-4 ">
                       <a class="text-dark" href="pages/show-book.html?id=${id}"><img class="card-header" src="${cover}" alt="Card image cap"></a>
                       <div class="card-body line-container">
                       <small class="text-primary"> ${genre}</small>
                       <p class="card-title single-line"><a class="text-dark" href="pages/show-book.html?id=${id}">${title}</a></p>
